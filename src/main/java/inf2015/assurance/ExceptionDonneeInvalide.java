...
public class ExceptionDonneeInvalide extends ExceptionSpecifique
{

  
public ExceptionDonneeInvalide(EnumCodeErreur typeErreur)
    {
    super(typeErreur, typeErreur.toString());
    }

public ExceptionDonneeInvalide(EnumCodeErreur typeErreur, String details)
    {
    super(typeErreur, details);
    }

public ExceptionDonneeInvalide(String msg) 
    {
    super(EnumCodeErreur.DONNEES_INVALIDES, msg);
    }
